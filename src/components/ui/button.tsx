  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white hover:shadow-glow hover:scale-105 transition-smooth shadow-card font-semibold dark:bg-primary dark:text-primary-foreground dark:hover:bg-primary/90",
        medical: "bg-gradient-card text-primary border border-primary/20 hover:bg-gradient-primary hover:text-white hover:shadow-glow transition-smooth",
        ai: "bg-accent text-accent-foreground hover:bg-accent/90 hover:shadow-glow transition-smooth"
      },
      size: {
