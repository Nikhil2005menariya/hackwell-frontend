...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 bg-gradient-hero dark:bg-gradient-to-br dark:from-background dark:via-background/95 dark:to-primary/10 overflow-hidden">
        {/* Animated Background */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`transition-all duration-1000 ${
              ...
              <div className="inline-flex items-center bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                <Sparkles className="w-4 h-4 text-yellow-300 mr-2" />
                <span className="text-white dark:text-foreground text-sm font-medium">AI-Powered Healthcare Revolution</span>
              </div>
              
              <h1 className="text-5xl md:text-7xl font-heading font-bold text-white dark:text-foreground mb-6 leading-tight">
                Predicting Risk for
                <span className="block text-white dark:text-primary drop-shadow-lg relative animate-pulse">
                  Chronic Diseases
                </span>
                with AI
              </h1>
              
              <p className="text-xl md:text-2xl text-white/90 dark:text-muted-foreground mb-8 max-w-2xl leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <Link to="/try-now">
                  <Button 
                    variant="hero" 
                    size="xl" 
                    className="bg-white dark:bg-primary text-primary dark:text-primary-foreground hover:scale-105 shadow-floating animate-pulse-glow relative overflow-hidden"
                  >
                ...
                <Link to="/about">
                  <Button 
                    variant="ghost" 
                    size="xl" 
                    className="text-white dark:text-foreground border-white/30 dark:border-border hover:bg-white/10 dark:hover:bg-accent/10 backdrop-blur-sm"
                  >
                    Learn More
                  </Button>
                </Link>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  return (
                    ...
                    >
                      <IconComponent className="w-5 h-5 text-white/70 dark:text-muted-foreground mb-2" />
                      <div className="text-2xl font-bold text-white dark:text-foreground mb-1">
                        {stat.value}{stat.suffix}
                      </div>
                      <div className="text-white/80 dark:text-muted-foreground text-xs">{stat.label}</div>
                    </div>
                  );
                })}
              </div>
            ...
            <div className={`transition-all duration-1000 delay-300 ${
              ...
              <div className="bg-white/10 dark:bg-card/50 backdrop-blur-sm p-6 rounded-2xl border border-white/20 dark:border-border">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-white dark:text-foreground font-semibold text-lg">Model Accuracy Trend</h3>
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
                    <span className="text-white/70 dark:text-muted-foreground text-sm">Live Data</span>
                  </div>
                </div>
                <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
                      <RechartsLineChart data={accuracyData}>
                        ...
                        <XAxis dataKey="month" stroke="rgba(255,255,255,0.7)" className="dark:stroke-muted-foreground" />
                        <YAxis stroke="rgba(255,255,255,0.7)" className="dark:stroke-muted-foreground" />
                        <Tooltip 
                          contentStyle={{
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="lg:col-span-1">
              <Card className="bg-card/90 dark:bg-card/50 backdrop-blur-sm border-border/50 h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {diseases.map((disease, index) => {
              ...
              return (
                <Card 
                  key={index} 
                  className="bg-card/80 backdrop-blur-sm border-border/50 hover-float transition-smooth cursor-pointer group animate-slide-up relative overflow-hidden"
